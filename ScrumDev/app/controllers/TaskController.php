...
class TaskController extends ControllerBase
{
    ...
    public function indexAction()
    {
		if(!$this->session->has('auth')){
			...
			if($this->session->has("id_sprint")){
				$task = Task::query()->where("id_sprint = :id_sprint:")->bind(array("id_sprint"=>$this->session->get("id_sprint")))->execute();
	...
	public function dependancyAction($id_task){
		$task = Task::query()->where("id_sprint = :id_sprint:")->andWhere("id_task <> :id_task:")->bind(array("id_sprint"=>$this->session->get("id_sprint"), "id_task"=>$id_task))->execute();
		$this->view->page = $task;
